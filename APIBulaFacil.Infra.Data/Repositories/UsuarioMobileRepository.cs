...
{
    public class UsuarioMobileRepository : BaseRepository<UsuarioMobile, Int32>, IUsuarioMobileRepository
    {
        private readonly DataContext context;

        public UsuarioMobileRepository(DataContext context) : base(context)
        {
